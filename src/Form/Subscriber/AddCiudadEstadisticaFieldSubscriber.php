 ...
 * @author eduardo
 */
class AddCiudadEstadisticaFieldSubscriber extends AddCiudadMunicipioFieldSubscriber
{
    ...
    {
        $form = $event->getForm();
        $form->add('ciudad', EntityType::class, ['class'=>Ciudad::class,'required' => false, 'choices' => array()]);
    }
