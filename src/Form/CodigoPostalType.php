...
class CodigoPostalType extends AbstractType
{
    ...
    {
        $builder
            ->add('d_Asenta',TextType::class,['label'=>'Nombre del Asentamiento','attr'=>['class'=>'form-control','autocomplete'=>'off']])
            ...
            ->add('id_asenta_cpcons',TextType::class,['label'=>'Identificador Único del Asentamiento(Nivel Municipal)','attr'=>['class'=>'form-control','autocomplete'=>'off']])
            ->add('estado',null,['placeholder'=>'Seleccione un estado'])
            ->add('c_CP',TextType::class,['attr'=>['class'=>'form-control','autocomplete'=>'off']])
        ;
